...
function getAngleBetweenVectors(x1, y1, x2, y2) {
    return Math.acos(((x1 + x2)**2 + (y1 + y2)**2 - (x1 + y1)**2 - (y2 + x2)**2)/(2*((x1 + y1)**2)*((x2 + y2)**2)));
}
...
function roundToPowerOfTen(num, pow) {
	switch(pow){
		...
		case 1: return Math.round(num / 10) * 10; break;
		case 2: return Math.round(num / 100) * 100; break;
		case 3: return Math.round(num / 1000) * 1000; break;
	}
}
