...
function encodeToRot13(str) {
    const input_char = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz';
    var output_char = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm';

    var result = '';
    var position;
    for (var ch of str) {
        result += (position = input_char.indexOf(ch)) == -1 ? ch : output_char[position];
    }
    return result;
}
